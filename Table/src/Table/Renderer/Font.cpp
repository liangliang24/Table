...
namespace Table
{
		...
		: m_Data(new MSDFData())
	{
		...
		if (!font)
		{
			TABLE_CORE_ERROR("Failed to load font: {}", fileString);
			return;
		}
		...
		TABLE_CORE_INFO("Loaded {} glyphs from font (out of {})", glyphsLoaded, charset.size());
...
#define THREAD_COUNT 8
	...
	Ref<Font> Font::GetDefault()
	{
		...
		if (!DefaultFont)
			DefaultFont = CreateRef<Font>("asset/fonts/Open_Sans/OpenSans-Regular.ttf");
