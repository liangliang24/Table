...
namespace YAML
{
	...
	template<>
	struct convert<Table::UUID>
	{
		static Node encode(const Table::UUID& uuid)
		{
			Node node;
		...
		static bool decode(const Node& node, Table::UUID& uuid)
		{
...
#define READ_SCRIPT_FIELD(FieldType, Type)             \
	...
	static std::string RigidBody2DBodyTypeToString(Rigidbody2DComponent::BodyType bodyType)
	{
		...
		TABLE_CORE_ASSERT(false, "Unknown body type");
		return {};
	}
